...
$pdf->Image('../logo/rdamarket.png',1,1,2,2);
$pdf->SetX(4);            
$pdf->MultiCell(19.5,0.5,'RDA MARKET',0,'L');
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'Telpon : 085799927177',0,'L');    
$pdf->SetFont('Arial','B',10);
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'JL. KADAR KM.1 TEMANGGUNG',0,'L');
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'website : www.rdamarket.com email : rdamarket@mart.com',0,'L');
